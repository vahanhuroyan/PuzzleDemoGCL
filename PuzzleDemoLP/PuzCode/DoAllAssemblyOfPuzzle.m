function [GI, GR, im, Results] = DoAllAssemblyOfPuzzle(ap,SCO,nr,nc,RotFlag,PositionKey,varargin)
...
[add_noise,add_normalization_noise,snr_para] = getPrmDflt(varargin, ... 
    {'add_noise',0,'add_normalization_noise',0,'snr_para',[]}, 1);
...
[G_,i_,GR] = GreedyAssembly5R(ap,SCO, nr,nc,varargin);
...
[newBlock_,newRotBlock_] = FillPuzzleHoles_V2(newBlock, newRotBlock, SCO, nr,nc,ScrambleRotations,varargin);
