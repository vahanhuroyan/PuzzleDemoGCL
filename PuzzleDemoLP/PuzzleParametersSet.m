...
str_pwd = pwd; k = strfind(str_pwd, '/vision/'); pathUCL_p1 = str_pwd(1:(k-1));

%% add subdirectories with current folder
addpath(genpath(pwd));

%% add gurobi
% addpath([pathUCL_p1 '/vision/humanis3/Rui/code/gurobi/gurobi563/linux64/matlab']);
% addpath([pathUCL_p1 '/vision/humanis3/Rui/code/gurobi/gurobi563/linux64/examples/matlab']);

addpath([pathUCL_p1 'C:/gurobi752/win64/matlab']);
addpath([pathUCL_p1 'C:/gurobi752/win64/examples/matlab']);


%% add Min/Max selection
% addpath([pathUCL_p1 '/vision/humanis3/Rui/code/MinMaxSelection/MinMaxSelection']);
...
dataset.root_path = 'C:/Users/vahan_0oroy10/Documents/MATLAB/PuzzleDemoLP/dataset';
% dataset.root_path = '/ima/imavisitor/huroy002/Dropbox/matlab/PuzzleDemoLP/dataset';

% dataset.piece_num = 432; %[432 540 805 2360 3300 5015 10375 22834];
% dataset.nr = 18; %[18 20 23 40 50 59 83 123];
% dataset.nc = 24; %[28 27 35 59 66 85 125 185];
% dataset.im_num = 20; %[20 20 20 3 3 20 20 20];
% dataset.name_format = '%d.png  ';%['%d.png  ';'%d.jpg  ';'%d.jpg  ';'%d.jpg  '; ...
    %'%d.jpg  ';'%02d.jpg';'%02d.jpg';'%02d.jpg'];

dataset.piece_num = [432 540 805 2360 3300 5015 10375 22834];
dataset.nr = [18 20 23 40 50 59 83 123];
dataset.nc = [28 27 35 59 66 85 125 185];
