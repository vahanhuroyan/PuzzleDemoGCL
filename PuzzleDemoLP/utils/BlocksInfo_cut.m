...
function [BlocksInfo_new,info_break_new] = BlocksInfo_cut(BlocksInfo,piece_num)
...
for i = 1:block_num
    ...
    [blocks,blocks_rot,blocks_img,info_break] = segment_gt(block,block_rot,block_img,piece_num);
