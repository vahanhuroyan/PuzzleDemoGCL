%% This is PuzzleMain function slightely modified by Vahan Huroyan
% to match the setting of our proposed puzzle solver by GCL.

function [res,max_rank_score, real_goal, BlocksInfo] = PuzzleMain_test(Parameters, ap, SCO, ppp, randscram, rot, ScrambleRotations,rigid_conncomp, do_replicate, buddy_check, loop_check, loop_check2, speed_up,ranking_method,varargin)
