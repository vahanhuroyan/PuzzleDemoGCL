function run_dataset5_on_cluster(job_num)
...
para = [];
[loop_struct,~] = para_loop_init('loop_id',loop_id_list,'rigid_conncomp',rigid_conncomp_list);
para = para_loop_set(para,job_num,loop_struct);
...
for num = 5
    ...
    loop_id = para.loop_id;
    rigid_conncomp = para.rigid_conncomp;
    
    buddy_check = buddy_check_list(loop_id);
    loop_check = loop_check_list(loop_id);
    loop_check2 = loop_check2_list(loop_id);
