function [res_all, err_all, rotsNum_first, rotsNum] = solve_type_2_img(img_path, init_eig_num)

    
%% load the puzzle
%     load(str_path); <- use this if you have already loaded and saved the puzzle
