...
%
function [large_Image] = printLargeImage( rgbParts, cols, rows, order, image_type, patch_distance)
...
%     disp(width)
    ...
    if(strcmp(image_type, 'png'))
        large_Image = uint16(large_Image);
    elseif(strcmp(image_type, 'jpg'))
        large_Image = uint8(large_Image);
    end
end
